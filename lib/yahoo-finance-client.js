...
// yahoo-finance2 has an internal queue with a 10s timeout by default.
// Residential proxies add latency — increase to 60s to prevent "Request was cancelled" errors.
yahooFinance._opts.queue = {
  ...yahooFinance._opts.queue,
  timeout: 60_000,
};
console.log("[YAHOO] Queue timeout set to 60s");
